...
rydbergConstant = fineStructureConstant.**.(U.realConstant U.dimensionless 2) .*. electronMass .*. speedOfLightInVacuum ./. (U.realConstant U.dimensionless 2 .*. planckConstant)
thomsonCrossSection = (U.realConstant U.dimensionless (8.0/3)) .*. U.piX .*. classicalElectronRadius.**.(U.realConstant U.dimensionless 2)
